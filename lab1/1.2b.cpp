...
static class TestDescription_MyTestSuite_test_a_form_peke : public CxxTest::RealTestDescription {
public:
 TestDescription_MyTestSuite_test_a_form_peke() : CxxTest::RealTestDescription( Tests_MyTestSuite, suiteDescription_MyTestSuite, 23, "test_a_form_peke" ) {}
 void runTest() { suite_MyTestSuite.test_a_form_peke(); }
} testDescription_MyTestSuite_test_a_form_peke;
